...
function main(){
    ...
    const sphereShadowBases = [];
    {
        ...
        for(let i = 0; i < numSpheres; i++){
            //making bases for shadow so the shadows move with spheres
            ...
            shadowMesh.position.y = 0.001; //so the shadow is slightly above ground and visible
    ...
    function render(time){
        ...
        sphereShadowBases.forEach( (sphereShadowBase, ndx) =>{
            ...
            //compute a position for there base. this will move both the sphere and the shadow
            ...
            //move the spheres up and down
            sphereMesh.position.y = y + THREE.MathUtils.lerp(-2,2,yOff);
            //fade the shadows as the spheres move away
